<?php 
    function truncateText($text, $maxWords = 29) {
        // Remove HTML tags
        ...
        // Preserve the formatting by adding back the HTML tags
        preg_match_all('/<[^>]+>/', $text, $tags);
        $tags = implode('', $tags[0]);
        $truncatedText = $tags . $truncatedText;
    ...
    // Truncate the text to 29 words
    $truncatedText = truncateText($text, 29);
